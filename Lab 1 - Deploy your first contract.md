...
We can now switch to the Explorer view briefly to see the files generated by the plugin for the new smart contract. To do this choose the top left folder shaped icon in the activity bar ( <img src="docs/doc-images/Lab1-8.png" width="50%" height="50%"> ).
...
Next we will package the smart contract. Click on the IBP icon in the sidebar to switch back to the IBM Blockchain Platform view. <img src="docs/doc-images/Lab1-10.png" width="50%" height="50%">
